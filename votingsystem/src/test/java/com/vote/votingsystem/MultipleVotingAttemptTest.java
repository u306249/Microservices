 ...
 */
public class MultipleVotingAttemptTest {
    ...
    public void testMotionPassQuery(){
    	...
    	Vote vote2 = new Vote("Anny",Opinion.Y,false);
    	Vote vote3 = new Vote("Anny",Opinion.Y,false);
    	Vote vote4 = new Vote("Anny",Opinion.Y,false);
